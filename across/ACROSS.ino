...
switch(dv)
  {
    case -1  :   state=0;
                 if(RWS==HIGH && LWS==HIGH) forward(PIDcal(0,1));
                 else 
                HRight(PIDcal(0,10));
                      break;
    case  0  :   if(RWS==HIGH && LWS==HIGH) forward(PIDcal(0,1));
                 else
                  ...
                  else 
                  {
                    ...
                    if(dir==LEFT) XHLeft(PIDcal(0,13));
                    else if(dir==RIGHT) XHRight(PIDcal(0,13));
                    else intersection();
                  }
                      break;
